...
/**
 * Transform MFA URL into a typed Resource Reference. The URL format handled is {@code http://server/context/mfa/}.
 *
...
@Named("mfa")
@Singleton
public class MFAResourceReferenceResolver extends AbstractResourceReferenceResolver
{
    @Override
    public MFAResourceReference resolve(ExtendedURL extendedURL, ResourceType resourceType,
        Map<String, Object> parameters) throws CreateResourceReferenceException, UnsupportedResourceReferenceException
    {
        ...
        MFAResourceReference reference = new MFAResourceReference(path, endpoint, pathSegments);
