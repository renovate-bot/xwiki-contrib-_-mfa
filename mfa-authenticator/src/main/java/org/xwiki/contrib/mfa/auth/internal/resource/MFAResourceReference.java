...
/**
 * Dummy type for MFA entry point.
 *
 * @version $Id: 97638fe25bc709cd9296ea452b5d13077aab014b $
 */
public class MFAResourceReference extends AbstractResourceReference
{
    /**
     * Represents a OpenID Connect Resource Type.
     */
    public static final ResourceType TYPE = new ResourceType("mfa");
     ...
     */
    public MFAResourceReference(String path, String endpoint, List<String> pathSegments)
    {
        setType(TYPE);
