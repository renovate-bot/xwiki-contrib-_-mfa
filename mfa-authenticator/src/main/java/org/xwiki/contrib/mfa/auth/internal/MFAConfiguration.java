...
/**
 * Various MFA configurations commons to both the all handlers.
 * 
 * @version $Id$
 */
@Component(roles = MFAConfiguration.class)
@Singleton
public class MFAConfiguration
{
    /**
     * The prefix used for MFA Connect configuration properties.
     */
    public static final String PREFIX_PROP = "mfa.";
